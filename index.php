...
<body>
    ...
    <div class="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative" data-dot="<img src='View/img/ashgrill.png'>">
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                ...
                                <p class="fs-5 fw-medium text-white mb-4 pb-3">AshGrill is the latest hub for Ashesi Student Businesses. We are a friendly and transparent Booking Agency based in Ashesi. We provide businesses an avenue to sell their goods at designated slots on campus. Accessible to the entire Ashesi community, any day of the week!</p>
            ...
            <div class="owl-carousel-item position-relative" data-dot="<img src='View/img/laila.jpg'>">
                <img class="img-fluid" src="View/img/laila.jpg" alt="">
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="fact-item text-center bg-light h-100 p-5 pt-0">
                        <div class="fact-icon">
                            <img src="View/img/icons/icon-2.png" alt="Icon">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="fact-item text-center bg-light h-100 p-5 pt-0">
                        <div class="fact-icon">
                            <img src="View/img/icons/icon-3.png" alt="Icon">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="fact-item text-center bg-light h-100 p-5 pt-0">
                        <div class="fact-icon">
                            <img src="View/img/icons/icon-4.png" alt="Icon">
                        </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p>AshGrill is the latest hub for Ashesi Student Businesses. We are a friendly and transparent Booking Agency based in Ashesi. We provide businesses an avenue to sell their goods at designated slots on campus. Accessible to the entire Ashesi community, any day of the week!
                        Expand the scope of your clientele.
                    </p>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        <img class="bg-img" src="View/img/snacks.jpg" alt="">
                        <div class="service-text p-5">
                            <!-- <img class="mb-4" src="View/img/snacks.jpg" alt="Icon"> -->
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        <img class="bg-img" src="View/img/clothes.jpg" alt="">
                        <div class="service-text p-5">
